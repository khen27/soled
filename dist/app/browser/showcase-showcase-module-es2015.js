...
const showcaseRoutes = [
    {
        ...
        children: [
            ...
            {
                path: 'app-shell',
                loadChildren: () => Promise.all(/*! import() | app-shell-app-shell-module */[__webpack_require__.e("common"), __webpack_require__.e("app-shell-app-shell-module")]).then(__webpack_require__.bind(null, /*! ./app-shell/app-shell.module */ "8Cws")).then(m => m.AppShellModule)
            },
            {
                path: 'custom-components',
                loadChildren: () => Promise.all(/*! import() | custom-components-custom-components-module */[__webpack_require__.e("common"), __webpack_require__.e("custom-components-custom-components-module")]).then(__webpack_require__.bind(null, /*! ./custom-components/custom-components.module */ "H2N2")).then(m => m.CustomComponentsModule)
            },
            {
                path: 'route-resolvers-ux',
                loadChildren: () => Promise.all(/*! import() | route-resolvers-ux-route-resolvers-ux-module */[__webpack_require__.e("common"), __webpack_require__.e("route-resolvers-ux-route-resolvers-ux-module")]).then(__webpack_require__.bind(null, /*! ./route-resolvers-ux/route-resolvers-ux.module */ "XxPA")).then(m => m.RouteResolversUXModule)
            }
        ]
    }
];
