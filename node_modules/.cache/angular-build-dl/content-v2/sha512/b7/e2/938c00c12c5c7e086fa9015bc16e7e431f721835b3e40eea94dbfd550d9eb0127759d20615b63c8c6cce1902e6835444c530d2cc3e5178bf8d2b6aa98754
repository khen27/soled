        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: () => Promise.all(/*! import() | categories-categories-module */[__webpack_require__.e("default~categories-categories-module~contact-card-contact-card-module~walkthrough-walkthrough-module"), __webpack_require__.e("categories-categories-module")]).then(__webpack_require__.bind(null, /*! ../categories/categories.module */ "kMJQ")).then(m => m.CategoriesPageModule)
                    },
                    {
                        path: 'fashion',
                        loadChildren: () => Promise.all(/*! import() | fashion-listing-fashion-listing-module */[__webpack_require__.e("default~fashion-details-fashion-details-module~fashion-listing-fashion-listing-module"), __webpack_require__.e("fashion-listing-fashion-listing-module")]).then(__webpack_require__.bind(null, /*! ../fashion/listing/fashion-listing.module */ "0toQ")).then(m => m.FashionListingPageModule)
                    },
                    {
                        path: 'fashion/:productId',
                        loadChildren: () => Promise.all(/*! import() | fashion-details-fashion-details-module */[__webpack_require__.e("default~fashion-details-fashion-details-module~fashion-listing-fashion-listing-module"), __webpack_require__.e("fashion-details-fashion-details-module")]).then(__webpack_require__.bind(null, /*! ../fashion/details/fashion-details.module */ "8DSg")).then(m => m.FashionDetailsPageModule)
                    },
                    {
                        path: 'food',
                        loadChildren: () => Promise.all(/*! import() | food-listing-food-listing-module */[__webpack_require__.e("default~deals-details-deals-details-module~deals-listing-deals-listing-module~food-details-food-deta~310374f5"), __webpack_require__.e("default~food-details-food-details-module~food-listing-food-listing-module"), __webpack_require__.e("food-listing-food-listing-module")]).then(__webpack_require__.bind(null, /*! ../food/listing/food-listing.module */ "6i+d")).then(m => m.FoodListingPageModule)
                    },
                    {
                        path: 'food/:productId',
                        loadChildren: () => Promise.all(/*! import() | food-details-food-details-module */[__webpack_require__.e("default~deals-details-deals-details-module~deals-listing-deals-listing-module~food-details-food-deta~310374f5"), __webpack_require__.e("default~food-details-food-details-module~food-listing-food-listing-module"), __webpack_require__.e("food-details-food-details-module")]).then(__webpack_require__.bind(null, /*! ../food/details/food-details.module */ "OQzY")).then(m => m.FoodDetailsPageModule)
                    },
                    {
                        path: 'travel',
                        loadChildren: () => Promise.all(/*! import() | travel-listing-travel-listing-module */[__webpack_require__.e("default~travel-details-travel-details-module~travel-listing-travel-listing-module"), __webpack_require__.e("travel-listing-travel-listing-module")]).then(__webpack_require__.bind(null, /*! ../travel/listing/travel-listing.module */ "HbU+")).then(m => m.TravelListingPageModule)
                    },
                    {
                        path: 'travel/:productId',
                        loadChildren: () => Promise.all(/*! import() | travel-details-travel-details-module */[__webpack_require__.e("default~travel-details-travel-details-module~travel-listing-travel-listing-module"), __webpack_require__.e("travel-details-travel-details-module")]).then(__webpack_require__.bind(null, /*! ../travel/details/travel-details.module */ "Tsqc")).then(m => m.TravelDetailsPageModule)
                    },
                    {
                        path: 'deals',
                        loadChildren: () => Promise.all(/*! import() | deals-listing-deals-listing-module */[__webpack_require__.e("default~deals-details-deals-details-module~deals-listing-deals-listing-module~food-details-food-deta~310374f5"), __webpack_require__.e("common"), __webpack_require__.e("deals-listing-deals-listing-module")]).then(__webpack_require__.bind(null, /*! ../deals/listing/deals-listing.module */ "bkrf")).then(m => m.DealsListingPageModule)
                    },
                    {
                        path: 'deals/:productId',
                        loadChildren: () => Promise.all(/*! import() | deals-details-deals-details-module */[__webpack_require__.e("default~deals-details-deals-details-module~deals-listing-deals-listing-module~food-details-food-deta~310374f5"), __webpack_require__.e("common"), __webpack_require__.e("deals-details-deals-details-module")]).then(__webpack_require__.bind(null, /*! ../deals/details/deals-details.module */ "pvlM")).then(m => m.DealsDetailsPageModule)
                    },
                    {
                        path: 'real-estate',
                        loadChildren: () => Promise.all(/*! import() | real-estate-listing-real-estate-listing-module */[__webpack_require__.e("default~real-estate-details-real-estate-details-module~real-estate-listing-real-estate-listing-module"), __webpack_require__.e("real-estate-listing-real-estate-listing-module")]).then(__webpack_require__.bind(null, /*! ../real-estate/listing/real-estate-listing.module */ "+Dkm")).then(m => m.RealEstateListingPageModule)
                    },
                    {
                        path: 'real-estate/:productId',
                        loadChildren: () => Promise.all(/*! import() | real-estate-details-real-estate-details-module */[__webpack_require__.e("default~real-estate-details-real-estate-details-module~real-estate-listing-real-estate-listing-module"), __webpack_require__.e("real-estate-details-real-estate-details-module")]).then(__webpack_require__.bind(null, /*! ../real-estate/details/real-estate-details.module */ "lkbD")).then(m => m.RealEstateDetailsPageModule)
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: () => Promise.all(/*! import() | user-profile-user-profile-module */[__webpack_require__.e("default~user-friends-user-friends-module~user-profile-user-profile-module"), __webpack_require__.e("user-profile-user-profile-module")]).then(__webpack_require__.bind(null, /*! ../user/profile/user-profile.module */ "sSds")).then(m => m.UserProfilePageModule)
                    },
                    {
                        path: 'friends',
                        loadChildren: () => Promise.all(/*! import() | user-friends-user-friends-module */[__webpack_require__.e("default~user-friends-user-friends-module~user-profile-user-profile-module"), __webpack_require__.e("user-friends-user-friends-module")]).then(__webpack_require__.bind(null, /*! ../user/friends/user-friends.module */ "SJx6")).then(m => m.UserFriendsPageModule)
                    }
                ]
            },
            {
...
const _c2 = function () { return ["/app/categories/fashion"]; };
const _c3 = function () { return ["/app/contact-card"]; };
class TabsPage {
    constructor(menu) {
        this.menu = menu;
    }
...
TabsPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TabsPage, selectors: [["app-tabs"]], decls: 14, vars: 12, consts: [[3, "ionTabsDidChange"], ["id", "tabOff", "slot", "bottom"], ["tab", "categories", 3, "routerLinkActive", "routerLink"], ["name", "home-outline"], [1, "tab-title"], ["tab", "categories/fashion", 3, "routerLinkActive", "routerLink"], ["name", "cart-outline"], ["tab", "contact-card", 3, "routerLinkActive", "routerLink"], ["name", "person-outline"]], template: function TabsPage_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonTabs"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonTabBar"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonTabButton"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterLinkActive"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["RouterLinkDelegate"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterLink"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonIcon"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonLabel"]], styles: ["ion-tab-button[_ngcontent-%COMP%] {\n  --color: var(--ion-color-medium-shade);\n  --color-selected: var(--ion-color-dark);\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
